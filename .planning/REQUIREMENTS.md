...
- [ ] **CNTR-01**: Counter-item rules query ability properties (channeled, passive, BKB-pierce) instead of hardcoded hero ID lists
...
- [ ] **CNTR-03**: Counter-item reasoning names the specific enemy ability being countered
- [ ] **CNTR-04**: Counter-item priority escalates based on enemy performance data (KDA from screenshots/GSI)
