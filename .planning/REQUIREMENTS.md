...
- [ ] **ENGN-01**: Rules layer fires instantly for obvious item decisions (e.g., Magic Stick vs spell-spamming lane opponents)
...
- [ ] **ENGN-06**: Matchup data pipeline fetches hero-vs-hero item win rates from OpenDota/Stratz and caches in SQLite
...
- [ ] **MIDG-01**: User can click items in the timeline to mark them as purchased (locked from re-evaluation)
...
- [ ] **MIDG-05**: User can hit Re-Evaluate to regenerate only unpurchased remaining items with updated game state
